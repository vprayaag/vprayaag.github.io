...
Some technical tools which would have been useful to know:
- Statistical learning theory
- Basics of empirical process theory, chaining
- Measure theory, different notions of convergence
- SK model and basic statistical physics: cavity method, replica method, smart path method, replica-symmetry, message passing, spin glass models, approximating partition functions and sampling
- Optimization: first-order, second-order, interior point, stochastic methods, acceleration, relationship between online and offline optimization, width-reduction in fast LP/SDP solvers (see Zeyuan Allen-Zhu's research), how to actually apply multiplicative-weights in practice
- Analysis of Boolean functions: hypercontracticity, Gaussian space, basic functional analysis, orthogonal polynomials (Hermite)
- Sum-of-Squares: Review of fundamentals, example applications to planted problems, lower bounds (pseudocalibration)
- Approximation algorithms: hardness, unique games, Raghavendra's basic SDP relaxation, primal-dual method, different types of convex relaxation rounding algorithms
- Leverage scores, subspace embeddings, sparsification and other topics related to dimensionality reduction

## 7/31/19

- \[0:45\]: Reviewed (again!) early parts of Section 8 in Raginsky notes.
- \[1:50\]: Started working on paper draft, but got distracted by new ideas. Need to read more into stochastic optimization.
- \[0:45\]: Finished revising introduction section of draft.
- \[0:50\]: Read through empirical process theory notes.

Past two days have been pretty horrible quality; no focus and mind-numbing.

## 7/30/19

- \[0:55\]: Reached Section 8.3 in Raginsky notes.
- \[1:20\]: Worked on paper draft.
- \[2:00\]: Reviewed as much as possible into El Alaoui thesis until reaching part that relies on smart path method. Began smart path method in Talagrand book. Need to take another detour to review Gaussian integration by parts and empirical process theory.
- \[0:45\]: Did a first pass over empirical process lecture notes.

Woke up 20 minutes late, got distracted in morning and afternoon.

## 7/29/19

- \[1:12\]: Read through most of Chapter 7 (skipped proof of Sauer-Shelah) of Raginsky notes.
- \[0:30\]: Skimmed over some recent papers on arXiv by Bandeira et al.
- \[0:10\]: Administrative stuff.
- \[0:25\]: Skimmed a video of talk by Will Perkins. Need to read up on Barvinok's method for approximating partition functions and explore connections.
- \[0:15\]: Revisited some papers on adversarially robust learning.
- \[1:20\]: Reviewed up to Section 2.5 in El Alaoui thesis. Need to learn Guerra's interpolation method and cavity method from Talagrand book, then return to Section 4.
- \[0:20\]: Updated paper draft slightly.
- \[1:10\]: Reached page 18 in Talagrand book. (After writing this down, seems pitiful.)


A lesson: After not touching the paper draft for a few days, completely lost train of thought and all momentum. More generally, after dip in number of hours worked these past two days, loss in momentum is hard to make up for. Got distracted easily in afternoon. In future, need to plan better how to maintain momentum even with reduced hours.

## 7/28/19

- \[1:35\]: Finished most of Chapter 6, except for Contraction Principle.
- \[1:20\]: Read Sections 1.1-1.2 and started Section 1.3 in Talagrand book.

## 07/27/19

- \[0:30\]: Read section 6.2, started following sections in Raginsky notes.

Occupied all day with other matters, much of tomorrow as well.

## 07/26/19

- \[1:23\]: Finished Chapter 5 and started Sections 6.1-6.2 in Raginsky notes.
- \[2:07\]: Read up to Section 2.5 in El Alaoui thesis. Might need to read first chapter of Talagrand's book.
- \[0:45\]: Read introduction and first 2 pages in Chapter 1 of Talagrand book.

Had errands (tomorrow as well), so limited time.

## 07/25/19

- \[1:20\]: Finished Sections 5.2-5.3 and started Section 5.4 in Raginsky notes.
- \[0:16\]: Figured out what techniques are involved in new paper. Next step is to read first chapter of El Alaoui thesis.
- \[3:34\]: Finished introduction and began first chapter of El Alaoui thesis.
- \[0:10\]: Added a few updates to paper draft.

## 07/24/19

- \[1:10\]: Did most of Sections 5.1-5.2 in Raginsky notes.
- \[1:40\]: Sent email to collaborators. Found a very well-written thesis which need to read; should help a lot with understanding statistical physics approach. Makes sense why these are the right tools to use. Identified some next steps; want to understand rank one spike cases first.
- \[0:15\]: Read part of introduction of El Alaoui thesis; need to read entire first half in future.
- \[0:20\]: Reviewed SoS certification algorithm for spiked tensor model; need to review SoS in general.
- \[1:32\]: Watched video of talk on tensor PCA and handwrote notes.

Had errand to run in afternoon, but today was much better than previous two days.
